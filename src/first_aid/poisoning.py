...
class Poisoning:
    ...
    def register_handlers(self):
        self.bot.app.add_handler(CallbackQueryHandler(self.main_poisoning_aid_info, pattern='^poisoning$'))


    async def main_poisoning_aid_info(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            message = await context.bot.send_video(
                ...
                caption="Первая помощь при отравлении через дыхательные пути",
