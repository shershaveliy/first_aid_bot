...
class Heat_stroke:
    ...
    def register_handlers(self):
        self.bot.app.add_handler(CallbackQueryHandler(self.main_heat_stroke_aid_info, pattern='^heat_stroke$'))


    async def main_heat_stroke_aid_info(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        text_with_link_path = os.path.join('src', 'first_aid', 'first_aid_text', 'heat_stroke', 'heat_stroke.txt')
